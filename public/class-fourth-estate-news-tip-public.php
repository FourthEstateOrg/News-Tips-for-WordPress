 ...
 */
class Fourth_Estate_News_Tip_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/fourth-estate-news-tip-public.css', array(), $this->version, 'all' );
